...
| `main_json` (оркестрация полного прогона) | [scripts/court_monitor/runs.py:2188](scripts/court_monitor/runs.py:2188) |
...
| `summarize_act_motivation` — LLM-пересказ акта | [scripts/court_monitor/digest/llm.py:916](scripts/court_monitor/digest/llm.py:916) |
| `polish_digest_html` — LLM-полировщик (опц.) | [scripts/court_monitor/digest/llm.py:1184](scripts/court_monitor/digest/llm.py:1184) |
...
| Claude model: `claude-haiku-4-5-20251001` (`_current_digest_model_name`) | [scripts/court_monitor/digest/llm.py:1325](scripts/court_monitor/digest/llm.py:1325) |
