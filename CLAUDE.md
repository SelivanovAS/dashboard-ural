...
| `announce_imported_appeal_cases` (дела из дампа апелляции → «Новые дела», один раз) | [scripts/court_monitor/runs.py:1922](scripts/court_monitor/runs.py:1922) |
...
| `intake_bank_rows` (блок 3b: приём исков банка с выдачи в прогоне) | [scripts/court_monitor/runs.py:1950](scripts/court_monitor/runs.py:1950) |
...
| `main_json` (оркестрация полного прогона) | [scripts/court_monitor/runs.py:2367](scripts/court_monitor/runs.py:2367) |
