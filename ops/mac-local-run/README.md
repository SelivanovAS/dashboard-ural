...
- `СберСуд-пульт.command` — двойной клик: меню «парсинг сейчас · дампы
  сейчас · живой лог · проверка» + статус облака в шапке. Старый ярлык
  «Парсинг судов.command» открывает его же.
