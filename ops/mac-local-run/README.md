...
- `com.court-monitor.parse.plist` — LaunchAgent парсинга (будни 09:00 и 11:00
  местного; второй слот — страховка «Mac спал в 09:00», при зрячем облаке гейт
  делает его тихим пропуском). `com.court-monitor.import.plist` — LaunchAgent
  дампов (будни 10:30–18:30 каждые 2 часа).
