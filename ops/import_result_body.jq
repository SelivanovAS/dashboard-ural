...
# =============================================================================
{
  ...
  # Ветка АПЕЛЛЯЦИИ (дамп капчёвого апел-суда, с 25.08.2026): сколько дел
  # приклеилось к уже известной 1-й инстанции. В `added` они не входят — там
  # только НОВЫЕ дела, а это уехавшее наверх известное дело.
  linked: (.linked // 0),

  # Ветка ПРЕЗИДИУМА (кассация по делам мировых судей, с 04.09.2026):
