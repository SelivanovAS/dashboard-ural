...
`validate_environment` ([1183](../../scripts/court_monitor/runs.py#L1183)) проверяет
наличие ключей на старте; `check_court_available` ([1211](../../scripts/court_monitor/runs.py#L1211))
