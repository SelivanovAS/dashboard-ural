...
([ops/writ_probe/report.txt](https://github.com/SelivanovAS/dashboard/blob/1a943a7f20b4dd48a54cadaf6af466d1deaac408/ops/writ_probe/report.txt), workflow
[probe_writ_section.yml](https://github.com/SelivanovAS/dashboard/blob/1a943a7f20b4dd48a54cadaf6af466d1deaac408/.github/workflows/probe_writ_section.yml)) и
...
- **Ввод пула — канал 2 (реестр)**: [scripts/import_bank_registry.py](../../../scripts/import_bank_registry.py)
  + workflow [import_bank_registry.yml](https://github.com/SelivanovAS/dashboard/blob/1a943a7f20b4dd48a54cadaf6af466d1deaac408/.github/workflows/import_bank_registry.yml) —
